# -----------------------------------------------------------------------------
# Count civil parishes, and see if there are more or fewer that when we last
# looked.
#
...
diff /home/${local_filesystem_user}/data/civilparishes_id.justnow /home/${local_filesystem_user}/data/civilparishes_id.temp
